...
|------------|------|---------|
| file://../internal-charts/admin-api | admin-api | 5.6.0 |
| file://../internal-charts/apidocs-server | apidocs-server | 5.6.0 |
| file://../internal-charts/authorization-api | authorization-api | 5.6.0 |
| file://../internal-charts/authorization-db | authorization-db | 5.6.0 |
| file://../internal-charts/cloud-sql-proxy | cloud-sql-proxy | 5.6.0 |
| file://../internal-charts/combined-db | combined-db | 5.6.0 |
| file://../internal-charts/content-api | content-api | 5.6.0 |
| file://../internal-charts/content-db | content-db | 5.6.0 |
| file://../internal-charts/correspondence-api | correspondence-api | 5.6.0 |
| file://../internal-charts/elasticsearch | elasticsearch | 5.6.0 |
| file://../internal-charts/gateway | gateway | 5.6.0 |
| file://../internal-charts/indexer | indexer | 5.6.0 |
| file://../internal-charts/ingress | ingress | 5.6.0 |
| file://../internal-charts/opensearch-dashboards | opensearch-dashboards | 5.6.0 |
| file://../internal-charts/opensearch | opensearch | 5.6.0 |
| file://../internal-charts/priorities | priorities | 5.6.0 |
| file://../internal-charts/rds-dev-proxy | rds-dev-proxy | 5.6.0 |
| file://../internal-charts/registry-api | registry-api | 5.6.0 |
...
| file://../internal-charts/tenant-db | tenant-db | 5.6.0 |
| file://../internal-charts/web-server | web-server | 5.6.0 |
| file://../magda-common | magda-common | 5.6.0 |
...
| global.postgresql.allowDefaultExternalDbPostgresUser | bool | `false` | When using external DB services (`useCloudSql` or `useAwsRdsDb`), chart rendering fails by default if `postgresqlUsername` is left as `postgres` to prevent accidental use of the wrong privileged account. Set this to `true` only when your external privileged account is intentionally named `postgres`. |
